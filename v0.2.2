...
try:
    ...
    z_0 = RegressionGPModel.addVars( range(len(X)), vtype = "C", name = "z_0")
    ...
    RegressionGPModel.addConstrs(z_0[i] == z for i in range(len(TempXi)))
    
    RegressionGPModel.setObjective(gp.quicksum(z_0), GRB.MINIMIZE)
